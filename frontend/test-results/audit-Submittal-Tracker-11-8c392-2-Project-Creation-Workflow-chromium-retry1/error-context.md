...
- Name: audit.spec.js >> Submittal Tracker: 11 Essential Guards Audit >> Guard 2: Project Creation Workflow
- Location: tests\audit.spec.js:21:3
...
Call log:
  - waiting for locator('button:has-text("Add Project")')
