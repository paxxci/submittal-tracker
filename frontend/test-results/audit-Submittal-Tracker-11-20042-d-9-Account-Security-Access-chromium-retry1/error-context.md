...
- Name: audit.spec.js >> Submittal Tracker: 11 Essential Guards Audit >> Guard 9: Account & Security Access
- Location: tests\audit.spec.js:99:3
...
Locator: locator('text=Password Management')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Password Management')
...
- generic [ref=e3]:
  - navigation [ref=e4]:
    ...
    - generic [ref=e12]:
      ...
      - button "Log Out" [active] [ref=e15] [cursor=pointer]:
        - img [ref=e16]
        - generic: Log Out
  - generic [ref=e19]:
    - generic [ref=e20]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e63] [cursor=pointer]:
        ...
        - img [ref=e70]
  - generic [ref=e78]:
    - heading "Log Out?" [level=2] [ref=e79]
    - generic [ref=e80]:
      - button "Cancel" [ref=e81] [cursor=pointer]
      - button "Log Out" [ref=e82] [cursor=pointer]
```
