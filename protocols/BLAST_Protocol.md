...
3. progress.md → What was done, errors, tests, results
...
You operate within a 3-layer architecture that separates concerns to maximize reliability (A.N.T.).
...
1. Payload Refinement: Format all outputs (Slack blocks, Notion layouts, Email HTML).
2. UI/UX: Apply clean CSS/HTML and intuitive layouts.
3. Feedback: Present stylized results to the user for feedback.

🛰️ Phase 5: T - Trigger (Deployment)
1. Cloud Transfer: Move finalized logic to production cloud.
...
1. The "Data-First" Rule: Before building any Tool, define the Data Schema in gemini.md.
2. Self-Annealing (The Repair Loop): Analyze trace -> Patch tool -> Test -> Update Architecture SOP.
3. Deliverables: Local (.tmp/) is ephemeral; Global (Cloud) is the destination.
